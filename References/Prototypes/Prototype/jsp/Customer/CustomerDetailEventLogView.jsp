		...
		<tr>
			...
			<td valign="top" height="*">
				<table border="0" width="100%" cellpadding="0" cellspacing="0" class="Form">
						...
						<td colspan="2">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="buttontop">
								...
								<tr>
									...
									<td><img src="../images/tab_02_01.gif" width="5" height="21" border="0"></td>
									<td align="center" background="../images/tab_02_02.gif"><a href="CustomerDetailCreditControlView.jsp"class="buttontop"><b>Credit Control</b></a></td>
									<td><img src="../images/tab_02_03.gif" width="10" height="21" border="0"></td>
									<td>&nbsp;</td>
					...
					<tr>
						<td>&nbsp;</td>
						<td colspan="2"><a href="CustomerDetailEventLogView.jsp" class="btnormal" tabindex="26">Filter</a></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
