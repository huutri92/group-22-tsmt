			...
			<td valign="top" height="*">
				<table border="0" width="100%" cellpadding="0" cellspacing="0" class="Form">
						...
						<td colspan="2">
							<table border="0" width="100%" cellpadding="0" cellspacing="0" class="FormWithBorder">
								...
								<tr>
									...
									<td>&nbsp;</td>
									<td class="Field">&nbsp;</td>
									<td class="Field"><input class="FieldLong" tabindex="" type="text" name="" size="20" value=""></td>
								</tr>
								<tr>
									...
									<td>&nbsp;</td>
									<td class="Field">&nbsp;</td>
									<td class="Field" rowspan="2"><textarea class="FieldLong" tabindex="23" name="memo1" cols="20" rows="3"></textarea></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>&nbsp;</td>
									<td class="Field">&pound;</td>
									<td class="Field"><input class="FieldDR" tabindex="" type="text" name="" size="20" value="590.00" readonly></td>
									<td>&nbsp;</td>
									<td class="Field">Memo 2</td>
									<td class="Field">&nbsp;</td>
									<td class="Field" rowspan="3"><textarea class="FieldLong" tabindex="24" name="memo2" cols="20" rows="4"></textarea></td>
								</tr>
								<tr>
					...
					<tr class="btnormal">
						<td>&nbsp;</td>
						<td colspan="2">
							<a href="../Customer/CustomerDetailAccount.jsp" class="btnormal" tabindex="25">Save</a>&nbsp;&nbsp;
						</td>
						<td>&nbsp;</td>
					</tr>
				</table>
