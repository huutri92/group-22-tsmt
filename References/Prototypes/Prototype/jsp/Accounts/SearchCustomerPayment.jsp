...
<head>
	...
	<title>Search Customer Payment</title>
</head>
			...
			<td valign="top" height="*">
				<table border="0" width="100%" cellpadding="0" cellspacing="0" class="Form">
						...
						<td colspan="2">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="buttontop">
								...
								<tr>
									...
									<td align="center" background="../images/tab_01_02.gif" class="selected"><b>Search Customer Payment</b></td>
					...
					<tr>
						...
						<td colspan="2">
							<table border="0" width="100%" cellpadding="0" cellspacing="0" class="FormWithBorder">
								...
								<tr>
									<td class="Field">Transaction From Date</td>
									<td>&nbsp;</td>
									<td class="Field">
								...
								<tr>
									<td class="Field">Transaction To Date</td>
									<td>
										&nbsp;</td>
									<td class="Field">
										<input class="FieldDate" tabindex="3" type="text" name="agreementDate" size="20">&nbsp;
					...
					<tr class="btnormal">
						<td>&nbsp;</td>
						<td colspan="2">
							<a href="SearchCustomerPaymentResult.jsp" class="btnormal" tabindex="25">Search</a>&nbsp;&nbsp;
							<a href="javascript:doReset();" class="btnormal" tabindex="25">Reset</a>&nbsp;&nbsp;
							<a href="../Customer/SearchCustomer.jsp" class="btnormal" tabindex="25">Setup Customer Payment</a>
						</td>
						<td>&nbsp;</td>
					</tr>
				</table>
