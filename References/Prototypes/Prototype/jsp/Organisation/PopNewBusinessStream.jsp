						...
						<td colspan="2">
							<table border="0" width="100%" cellpadding="0" cellspacing="0" class="FormWithBorder">
								...
								<tr>
									...
									<td class="Field"><input class="FieldNormal" type="text" name="name" value=""></td>
									<td class="Field">&nbsp;</td>
								</tr>
								<tr>
									<td class="Field">Description</td>
									<td class="Field"><input class="FieldNormal" type="text" name="name0" value=""></td>
									<td class="Field">&nbsp;</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="Field"><input class="FieldDR" type="text" name="lastName4" value="">&nbsp; weeks</td>
									<td class="Field">&nbsp;</td>
								</tr>
								<tr>
									<td class="Field">New Customer Definition</td>
									<td class="Field"><input class="FieldDR" type="text" name="lastName14" value="" size="20">&nbsp; weeks</td>
									<td class="Field">&nbsp;</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						...
						<td colspan="2">
							<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
								...
								<tr class="field20">
									<td>Up To</td>
									<td><input class="FieldDR" type="text" name="lastName12" value=""> %</td>
									<td><input class="FieldDR" type="text" name="lastName12" value=""> %</td>
								</tr>
								<tr class="field20">
									<td>To</td>
									<td><input class="FieldDR" type="text" name="lastName6" value=""> %</td>
									<td><input class="FieldDR" type="text" name="lastName12" value=""> %</td>
								</tr>
								<tr class="field20">
									<td>To</td>
								...
								<tr class="field20">
									<td>To</td>
									<td><input class="FieldDR" type="text" name="lastName8" value="" onblur="javascript:doChange(this);"> %</td>
									<td><input class="FieldDR" type="text" name="lastName8" value=""> %</td>
								</tr>
								<tr class="field20">
									<td>Above</td>
									<td><span class="FieldDR" id="above"></span>&nbsp;%</td>
