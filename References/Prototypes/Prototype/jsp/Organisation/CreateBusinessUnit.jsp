...
<head>
	...
	<title>Setup Business Unit</title>
</head>
		...
		<tr>
			...
			<td valign="top" rowspan="2" bgcolor="#E0E9F2" height="100%">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" height="400">
					<tr>
						<td valign="bottom" height="300">&nbsp;</td>
					</tr>
					<tr>
						...
						<td colspan="2">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="buttontop">
								...
								<tr>
									...
									<td align="center" background="../images/tab_02_02.gif" nowrap><a href="javascript:doSummary();" class="buttontop">Summary Information</a></td>
					...
					<tr>
						...
						<td colspan="2">
							<table border="0" width="100%" cellpadding="0" cellspacing="0">
									...
									<td valign="top" height="212">
										<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr class="field20">
												...
												<td nowrap><input class="FieldNormal" type="text" name="" value="" size="15"></td>
											</tr>
											<tr class="field20">
												<td nowrap>Status <font color="#FF0000">*</font></td>
												<td nowrap height="16">
													<select size="1" name="status" class="FieldNormal">
														<option value=""></option>
											...
											<tr class="field20">
												...
												<td nowrap>
													<select size="1" name="parentUnit" class="FieldNormal">
														<option value=""></option>
									...
									<td valign="top" height="212">
										<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr class="field220">
												...
												<td nowrap><input class="FieldNormal" type="text" name="" value="239 Xuan Thuy"></td>
											</tr>
											</tr>
											<tr class="field220">
												<td nowrap>Street</td>
												<td nowrap><input class="FieldNormal" type="text" name="" value="Cau Giay" size="20"></td>
											</tr>
											<tr class=field2 valign=middle>
												<td>Town/City</td>
												<td><input class="FieldNormal" type="text" name="" value="Ha Noi" size="20"></td>
											</tr>
											<tr class="field220">
											...
											<tr class="field220">
												...
												<td nowrap><input class="field20" type="text" name="" value="" size="20"></td>
											</tr>
											<tr class="field220">
												<td nowrap>PDA Used</td>
												<td nowrap><input type="checkbox" class="checkbox"  name="C1" value="ON" checked style="padding-left:0px"></td>
											</tr>
											<tr class="field220">
												<td nowrap>&nbsp;</td>
												<td nowrap >&nbsp;</td>
								...
								<tr class=btnormal>
									<td colspan="3"><a href="javascript:doSave()" class="btnormal" tabindex="26">Save</a>&nbsp;</td>
								</tr>
								<tr>
									<td colspan="3">&nbsp;</td>
								</tr>
