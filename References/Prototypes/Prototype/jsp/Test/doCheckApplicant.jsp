...
<tr>
<td class="frmText" style="color: #000000; font-weight:normal;">surname</td>
<td class="frmText" style="color: #000000; font-weight:normal;">string</td>
<td><input class="frmInput" type="text" size="50" name="surname"></td>
</tr>
<tr>
<td class="frmText" style="color: #000000; font-weight:normal;">forename</td>
<td class="frmText" style="color: #000000; font-weight:normal;">string</td>
<td><input class="frmInput" type="text" size="50" name="forename"></td>
</tr>
<tr>
<td class="frmText" style="color: #000000; font-weight:normal;">niNumber</td>
<td class="frmText" style="color: #000000; font-weight:normal;">string</td>
<td><input class="frmInput" type="text" size="50" name="niNumber"></td>
</tr>
<tr>
<td class="frmText" style="color: #000000; font-weight:normal;">dateOfBirth</td>
<td class="frmText" style="color: #000000; font-weight:normal;">Date</td>
<td><input class="frmInput" type="text" size="50" name="dateOfBirth"></td>
</tr>
<tr>
<td class="frmText" style="color: #000000; font-weight:normal;">houseNumberName</td>
<td class="frmText" style="color: #000000; font-weight:normal;">string</td>
<td><input class="frmInput" type="text" size="50" name="houseNumberName"></td>
</tr>
<tr>
...
previousHouseNumberName</td>
<td class="frmText" style="color: #000000; font-weight:normal;">string</td>
<td><input class="frmInput" type="text" size="50" name="previousHouseNumberName"></td>
</tr>
<tr>
<td class="frmText" style="color: #000000; font-weight:normal;">previousPostcode</td>
<td class="frmText" style="color: #000000; font-weight:normal;">string</td>
<td><input class="frmInput" type="text" size="50" name="previousPostcode"></td>
</tr>
<tr><td></td><td></td>
...
<th class="frmHeader" BGCOLOR="#dcdcdc" style="border-right: 2px solid white;">
customerGUID</th>
<th class="frmHeader" BGCOLOR="#dcdcdc"  style="border-right: 2px solid white;">salutation + surname + forname</th>
<th class="frmHeader" BGCOLOR="#dcdcdc"  style="border-right: 2px solid white;">dateOfBirth</th>
<th class="frmHeader" BGCOLOR="#dcdcdc"  style="border-right: 2px solid white;">correspondenceAddress</th>
<th class="frmHeader" BGCOLOR="#dcdcdc"  style="border-right: 2px solid white;">status</th>
<th class="frmHeader" BGCOLOR="#dcdcdc"  style="border-right: 2px solid white;">averageDebitPerformance</th>
</tr>
<tr>
