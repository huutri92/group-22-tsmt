...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        if (acc.Role.RoleName.Equals("Admin"))
        {
            BaseUrl = "/Content/UserUpload/";
        }
        else
        {
            string accPath = acc.Profile.Firstname + acc.Profile.Lastname + acc.AccountID;
            // The base URL used to reach files in CKFinder through the browser.
            BaseUrl = "/Content/UserUpload/" + accPath + "/";
        }
