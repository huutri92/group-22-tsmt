									...
									<td valign="top">
										<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr>
												...
												<td class="Field" >
													<select class="ListWidth160" name="adjustmentTypeId" onChange="javascript:doSelectAdjustmentType();">
											...
											<tr>
												...
												<td class="Field">
													<span id="reason">
														<select class="ListWidth160" name="increaseReason" onchange="javascript:doSelectReason();">
															<option value="0" selected>Manual finance charge</option>
															<option value="1">Manual PPI premium</option>
															<option value="2">Product admin fee</option>
															<option value="3">Bounced cheque</option>
															<option value="4">Handing fee</option>
															<option value="5">Cash adjustment</option>
															<option value="6">Sale adjustment</option>
															<option value="7">Debit purchase</option>
															<option value="8">Reverse voucher</option>
															<option value="9">Reverse discount</option>
															<option value="10">Reverse PPI settlement</option>
															<option value="11">Reverse sale cancellation</option>
													...
													<td>&nbsp;</td>
													<td class="Field" align="left"><span id="span_cheque1">&nbsp;</span></td>
													<td class="Field">&nbsp;</td>
											</tr>
											<tr>
												...
												<tr class="Field">
													<td colspan='5'><span id="span_results"></span></td>
								...
								<tr>
									<td colspan="3">
										<table border="0" width="100%" cellpadding="1" cellspacing="1" class="FormWithBorder">
											...
											<tr class="Section">
												<th class="Title" colspan="11" align="center"><b>RECORD TRANSACTIONS - ADJUSTMENT</b></th>											
											</tr>
											<tr class="Section">
...
<script language="javascript">
	...
	function doSelectAdjustmentType() {
		...
		window.document.getElementById("span_cheque1").innerHTML = "";
		window.document.getElementById("span_results").innerHTML = "";
		if (index == '0') {
			document.getElementById("reason").innerHTML="<select class='ListWidth160' name='increaseReason' onchange='javascript:doSelectReason();'>" + 
														"<option value='0' selected>Manual finance charge</option>" +
														"<option value='1'>Manual PPI premium</option>" +
														"<option value='2'>Product admin fee</option>" +
														"<option value='3'>Bounced cheque</option>" +
			...
			document.getElementById("reason").innerHTML="<select class='ListWidth160' name='increaseReason'>" + 
														"<option value='13'>Promotional voucher</option>" +
														"<option value='14'>Into discount</option>" +
														"<option value='15'>Product discount</option>" +
														"<option value='16'>PPI settlement</option>" +
														"<option value='17'>Cash adjustment</option>" +
														"<option value='18'>Sale adjusment</option>" +
														"<option value='19'>Sale cancellation</option>" +
														"<option value='20'>Finance charge rebate</option>" +
														"<option value='21'>PPI premium rebate</option>" +
														"<option value='22'>Reserve admin fee</option>" +
														"<option value='23'>Reserve handing fee</option>" +
														"<option value='24'>Reserve debt purchase</option></select>";
		}
	}
	...
	function doSelectReason() {
		
		if (thisForm.increaseReason.value == 3) {

			window.document.getElementById("span_cheque1").innerHTML = "<a href='javascript:doOpenResults();' class='btnormal'>Search</a>";
		} else {
			window.document.getElementById("span_cheque1").innerHTML = "";
			window.document.getElementById("span_results").innerHTML = "";
		}
	...
	function doOpenResults() {
		var width = 600;
		var height = 300;
		var newWin = window.open("PopAccountTransactionResults.jsp", "", centerWindow(width, height));
	}
</script>
</body>
