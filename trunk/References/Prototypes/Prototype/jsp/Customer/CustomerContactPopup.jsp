		...
		<tr>
			...
			<td colspan="2">
				<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td class="Field">Date Of Birth&nbsp;<font color="red">*</font></td>
						<td >&nbsp;</td>
						<td class="Field"><input class="FieldDate" type="text" id ="txtDob" name="dob" > &nbsp; dd/mm/yyyy</td>
						<td class="Field">&nbsp;</td>
					</tr>			
					<tr>
						<td class="Field">Memorable Data Prompt&nbsp;<font color="red">*</font></td>
						<td >&nbsp;</td>
						<td class="Field"><input class="FieldNormal" maxlength ="30"  type="text" name="firstName" size="20" value=""></td>						
						<td class="Field">&nbsp;</td>
					</tr>
					<tr>
