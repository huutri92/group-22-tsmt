		...
		<tr>
			...
			<td valign="top" height="*">
				<table border="0" width="100%" cellpadding="0" cellspacing="0" class="Form">
						...
						<td colspan="2">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="buttontop">
								...
								<tr>
									...
									<td align="center" background="../images/tab_01_02.gif" class="selected"><b>Add Business Stream</b></td>
						...
						<td colspan="2">
							<table border="0" width="100%" cellpadding="0" cellspacing="0" class="FormWithBorder">
								...
								<tr>
									...
									<td>&nbsp;</td>
									<td class="Field"><input class="FieldNormal" type="text" name="name" size="20"></td>
									<td class="Field">&nbsp;</td>
									<td>&nbsp;</td>
									<td class="Field" valign="top">Description</td>
									<td>&nbsp;</td>
									<td class="Field" rowspan="4"><textarea class="FieldLong" name="description" cols="20" rows="5" tabindex="9"></textarea></td>
									<td class="Field">&nbsp;</td>
									<td class="Field">&nbsp;</td>
								</tr>
								<tr>
									<td class="Field">Credit Control Scheme</td>
									<td>&nbsp;</td>
									<td class="Field">
								...
								<tr>
									...
									<td>&nbsp;</td>
									<td class="Field">
										<input class="FieldNormal" type="text" name="statementFrequency" size="20">
									</td>
									<td class="Field">&nbsp;</td>
									<td>&nbsp;</td>
									<td class="Field">&nbsp;</td>
					...
					<tr class="btnormal">
						<td>&nbsp;</td>
						<td colspan="2"><a href="BusinessStream.jsp" class="btnormal" >Save</a></td>
						<td>&nbsp;</td>
					</tr>
				</table>
			</td>
