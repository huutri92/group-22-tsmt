									...
									<td valign="top">
										...
										<table border="0" width="100%" cellpadding="0" cellspacing="0" class="FormWithBorder">
											...
											<tr height="20">
												...
												<td class="Field" colspan="1"><input type="textbox" class="FieldShortR" name="" value="AB012"></td>
												<td class="Field" colspan="1" align = "right">Date</td>
												<td class="Field" colspan="1" align = "center">	<input class="FieldDate" type="text" id = "negotiatedDate" name="negotiatedDate" size="20" value="15/10/2005">&nbsp;
													<a href="#"><img id="btAFD" src="../images/calendar.gif" border="0" width="16" height="14"></a>
													<script type="text/javascript">
														<!--
															Calendar.setup({
															  inputField	: "negotiatedDate",
															  button		: "btAFD",
															  align		 : "Tr",
															  ifFormat	  : "%d/%m/%Y",
															  daFormat	  : "%d/%m/%Y",
											...
											<tr height="20">
												...
												<td class="Field" colspan="1"><input type="textbox" class="FieldShortR"name="" value="100.00">(&pound;)</td>
												<td class="Field" colspan="1" align = "right">Date</td>
												<td class="Field" colspan="1" align = "center">
													<input class="FieldDate" type="text" id = "negotiatedDate" name="negotiatedDate" size="20">&nbsp;
													<a href="#"><img id="btAFD" src="../images/calendar.gif" border="0" width="16" height="14"></a>
													<script type="text/javascript">
														<!--
															Calendar.setup({
											...
											<tr height="20">
												...
												<td class="Field" colspan="3"><input class="checkbox" type="checkbox" name="" checked></td>
											</tr>
											<tr height="20">
												...
												<td colspan="4">
													...
													<table border="0" width="100%" cellpadding="1" cellspacing="1" class="FormWithBorder">
														...
														<tr class="Field" height = "20">
															...
															<td>07/10/2005</td>
															<td>L</td>
															<td><input type="textbox" class="FieldShortR"name="" value="AB00023"></td>
														</tr>
														...
														<tr class="Field2" height = "20">
															...
															<td>03/05/2005</td>
															<td>E</td>
															<td><input type="textbox" class="FieldShortR"name="" value="AB00033"></td>
														</tr>
														...
														<tr class="Field" height = "20">
															...
															<td>07/10/2004</td>
															<td>L</td>
															<td><input type="textbox" class="FieldShortR"name="" value="AB00013"></td>
														</tr>
											...
											<tr >
												<td colspan="4">
													<a href="CustomerStatement.jsp" class="btnormal" >Save</a>
													<a href="CustomerStatementView.jsp" class="btnormal" >Cancel</a>
												</td>
											</tr>
											<tr class="Section">
