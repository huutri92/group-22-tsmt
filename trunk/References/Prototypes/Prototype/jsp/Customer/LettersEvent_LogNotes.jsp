			...
			<td colspan="2">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="buttontop">
					...
					<tr>
						...
						<td align="center" background="../images/tab_01_02.gif" class="selected"><b>Log Notes</b></td>
...
<!--				<tr>
						<td class="Field">Log Type <font color="#FF0000">*</font></td>
						<td>&nbsp;</td>
						<td class="Field">
					...
					<tr>
						<td class="Field">Reason Type <font color="#FF0000">*</font></td>
						<td>&nbsp;</td>
						<td class="Field">
					...
					<tr>
						<td class="Field">User <font color="#FF0000">*</font></td>
						<td>&nbsp;</td>
						<td class="Field"><input type="text" class="FieldxDate" name="" value="HaiVH" readonly></td>
					</tr>			
					<tr>
						<td class="Field">Date/Time <font color="#FF0000">*</font></td>
						<td>&nbsp;</td>
						<td class="Field">
					...
					<tr>
						<td class="Field" valign="top">Description <font color="#FF0000">*</font></td>
						<td>&nbsp;</td>
						<td class="Field"><textarea class="FieldXLong" name="description" cols="100" rows="5" style="width:100%;">Arrears letter TL1 issued</textarea></td>
					</tr>
					<tr>
						<td class="Field" valign="top">Log Notes</td>
						<td>&nbsp;</td>
						<td class="Field"><textarea class="FieldXLong" name="result" cols="100" rows="5" style="width:100%;"></textarea></td>
					</tr>
-->					
					<tr>
						<td height="200px" valign="top">Go to school Le Quy Don</td>
					</tr>
				</table>
			</td>
			<td>&nbsp;</td>
