						...
						<td>
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="buttontop">
								...
								<tr>
									...
									<td><img src="../images/tab_02_01.gif" width="5" height="21" border="0"></td>
									<td align="center" background="../images/tab_02_02.gif" nowrap><a href="CustomerDetailsView.jsp" class="buttontop">Details Info</a></td>
									<td><img src="../images/tab_02_03.gif" width="5" height="21" border="0"></td>
									<td>&nbsp;</td>
									
									<td><img src="../images/tab_02_01.gif" width="5" height="21" border="0"></td>
									<td align="center" background="../images/tab_02_02.gif" nowrap><a href="CustomerLettersEventView.jsp"class="buttontop">Letters/Event Log</a></td>
									<td><img src="../images/tab_02_03.gif" width="5" height="21" border="0"></td>
									<td>&nbsp;</td>
					...
					<tr>
						...
						<td>
							<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td valign="top">
										<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr>
												<td class="Field"><span id="spanPayment">Cheque Account Number</span></td>
												<td class="Field">
									...
									<td colspan="3">
										<table border="0" width="100%" cellpadding="1" cellspacing="1" class="FormWithBorder">
											...
											<tr class="Section">
												...
												<th class="Title"><b>Payments</b></th>
								...
								<tr >
									<td><a href="CustomerTransactionsPaymentView.jsp" class="btnormal" >Save</a></td>
...
<script language="javascript">
	...
	function doSelectTransactionType() {
		...
		if (index == 0) {
			window.location.href = "CustomerTransactionsSaleView.jsp";
		} else if (index == 1) {
			window.location.href = "CustomerTransactionsCancelView.jsp";
		} else if (index == 3) {
			window.location.href = "CustomerTransactionsAdjustmentView.jsp";
		}
