						...
						<td colspan="2">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="buttontop">
								...
								<tr>
									...
									<td><img src="../images/tab_02_01.gif" width="5" height="21" border="0"></td>
									<td align="center" background="../images/tab_02_02.gif" class="selected"><a href="CustomerDetailAccountView.jsp"class="buttontop"><b>Accounts</b></a></td>
									<td><img src="../images/tab_02_03.gif" width="10" height="21" border="0"></td>
									<td>&nbsp;</td>
									
									<td><img src="../images/tab_02_01.gif" width="5" height="21" border="0"></td>
									<td align="center" background="../images/tab_02_02.gif" class="selected"><a href="CustomerDetailHistoryView.jsp"class="buttontop"><b>History</b></a></td>
									<td><img src="../images/tab_02_03.gif" width="10" height="21" border="0"></td>
									<td>&nbsp;</td>
									
									<td><img src="../images/tab_02_01.gif" width="5" height="21" border="0"></td>
									<td align="center" background="../images/tab_02_02.gif" class="selected"><a href="CustomerDetailCreditControlView.jsp"class="buttontop"><b>Credit Control</b></a></td>
									<td><img src="../images/tab_02_03.gif" width="10" height="21" border="0"></td>
									<td>&nbsp;</td>

									
									<td><img src="../images/tab_02_01.gif" width="5" height="21" border="0"></td>
									<td align="center" background="../images/tab_02_02.gif" class="selected"><a href="CustomerDetailEventLogView.jsp"class="buttontop"><b>Event Logs</b></a></td>
									<td><img src="../images/tab_02_03.gif" width="10" height="21" border="0"></td>
									<td>&nbsp;</td>
								</tr>
							</table>
						...
						<td colspan="2">
							<table border="0" width="100%" cellpadding="0" cellspacing="0" class="FormWithBorder">
								...
								<tr>
									...
									<td>&nbsp;</td>
										<td class="Field"><input type="text" class="FieldxShort" maxLength="20" name="collectionPostCode1" size="20" value ="81">&nbsp;<img id="btFinishDate0" src="../images/search.gif" border="0" width="15" height="15"></td>
										<td class="Field">&nbsp;</td>
										<td>&nbsp;</td>
										<td class="Field"><input type="text" class="FieldxShort" maxLength="20" name="collectionPostCode2" size="20" value ="83">&nbsp;<img id="btFinishDate0" src="../images/search.gif" border="0" width="15" height="15"></td>
										<td class="Field">&nbsp;</td>
										<td class="Field">&nbsp;</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>&nbsp;</td>
										<td class="Field"><input type="text" class="FieldxShort" maxLength="20" name="collectionPostCode3" size="20">&nbsp;<img id="btFinishDate0" src="../images/search.gif" border="0" width="15" height="15"></td>
										<td class="Field">&nbsp;</td>
										<td>&nbsp;</td>
										<td class="Field">&nbsp;</td>
										<td class="Field">
