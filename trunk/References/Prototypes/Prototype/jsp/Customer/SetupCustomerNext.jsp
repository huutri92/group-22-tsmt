									...
									<td valign="top">
										<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr class="Field">
												...
												<td>&nbsp;</td>
												<td class="Field">
													<select size="1" name="businessUnit" class="FieldShort" disabled>
											...
											<tr class="Field">
												...
												<td>&nbsp;</td>
												<td class="Field">
													<select size="1" name="salutation" class = "FieldDate" disabled>
											...
											<tr class="field">
												...
												<td>&nbsp;</td>
												<td class="Field"><input class="FieldNormal" type="text" disabled value ="Vu Quang" name="firstName" size="20"></td>	
											</tr>
											<tr class="field">
												<td class="Field">Surname&nbsp;<font color="red">*</font></td>
												<td>&nbsp;</td>
												<td class="Field"><input class="FieldNormal" type="text"  value ="Hung" disabled name="surname" size="20"></td>
											</tr>
											<tr class="field">
												<td class="Field">Initials</td>
												<td>&nbsp;</td>
												<td class="Field">
													<input class="FieldxShort" type="text" name="initials" value ="A" disabled size="20"></td>
											<tr class="field">
												<td class="Field">NI Number</td>
												<td>&nbsp;</td>
												<td class="Field"><input class="FieldNormal" type="text" disabled name="niNumber" size="20"></td>
											</tr>
											</tr>
											<tr class="field">
											...
											<tr class="field">
												...
												<td>&nbsp;</td>
												<td class="Field">
													<input class="FieldNormal" type="text" value ="202" disabled name="lastName8" size="20"></td>													</tr>
											<tr class="field">
												<td class="Field">Street Name&nbsp;<font color="red">*</font></td>
												<td>&nbsp;</td>
												<td class="Field">
													<input class="FieldNormal" value ="Ronny street" type="text" disabled name="lastName12" size="20"></td>	
											</tr>
											<tr class="field">
												<td class="Field">Town/City</td>
												<td>&nbsp;</td>
												<td class="Field">
													<input class="FieldNormal" value ="Manchester" type="text" disabled name="townCity1" size="20"></td>											</tr>
											<tr class="field">
												<td class="Field">County</td>
												<td>&nbsp;</td>
												<td class="Field">
													<input class="FieldNormal" value ="York" type="text" disabled name="townCity1" size="20"></td>												</tr>
											<tr class="field">
												<td class="Field">Postcode&nbsp;<font color="red">*</font></td>
												<td>&nbsp;</td>
												<td class="Field"><input class="FieldShort" value ="GU11 1EJ" type="text" disabled name="postCode" size="20"></td>
											</tr>
											<tr class="field">
												<td class="Field">Home Telephone</td>
												<td>&nbsp;</td>
												<td class="Field">
													<input class="FieldNormal" type="text" value ="049098090" disabled name="homePhone" size="20"></td>	
											<tr class="field">
												<td class="Field">Mobile Telephone</td>
												<td>&nbsp;</td>
												<td class="Field">
													<input class="FieldNormal" type="text" value ="0908098090" disabled name="mobilPhone" size="20"></td>	
											<tr class="field">
											...
											<tr class="field">
												...
												<td>&nbsp;</td>
												<td class="Field">
													<input class="FieldNormal" type="text" disabled name="lastName8" size="20"></td>													</tr>
											<tr class="field">
												<td class="Field">Street Name&nbsp;<font color="red">*</font></td>
												<td>&nbsp;</td>
												<td class="Field">
													<input class="FieldNormal" type="text" disabled name="lastName12" size="20"></td>	
											</tr>
											<tr class="field">
												<td class="Field">Town/City</td>
												<td>&nbsp;</td>
												<td class="Field">
													<input class="FieldNormal" type="text" disabled name="townCity1" size="20"></td>											</tr>
											<tr class="field">
												<td class="Field">County</td>
												<td>&nbsp;</td>
												<td class="Field">
											...
											<tr class="field">
												<td class="Field">Postcode&nbsp;<font color="red">*</font></td>
												<td>&nbsp;</td>
												<td class="Field"><input class="FieldShort" disabled type="text" name="postCode" size="20"></td>
											</tr>
											...
											<tr class="field">
												...
												<td>&nbsp;</td>
												<td class="Field">
													<input class="FieldNormal" disabled type="text" name="lastName8" size="20"></td>
											</tr>
									...
									<td valign="top">
										<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr class="field2">
												...
												<td nowrap colspan="5">
													<input type="checkbox" class="checkbox"  name="C1" value="ON" style="padding-left:0px"></td>
											</tr>
											<tr class="field2">
												<td nowrap>Application Form</td>
												<td nowrap>Completed&nbsp;&nbsp;&nbsp;</td>
												<td nowrap><input type="checkbox" class="checkbox" name="C2" value="ON" ></td>
												<td nowrap colspan="2" >Scanned&nbsp;&nbsp;&nbsp;<input type="checkbox" class="checkbox"  name="C3" value="ON" ></td>
												<td nowrap>&nbsp;</td>
											</tr>
											<tr class="field2">
												<td class="Field">Application Form Date&nbsp;<font color="red">*</font></td>
												<td class="Field">
													<input class="FieldDate" type="text" id = "txtappFormDate" name="appFormDate" size="20">&nbsp;</td>
											...
											<tr class="field2">
												...
												<td nowrap>
													<input type="checkbox"  class="checkbox" name="C4" value="ON" ></td>
												<td nowrap colspan="3">Proof of Identification&nbsp;&nbsp;&nbsp;<input type="checkbox"  class="checkbox" name="C6" value="ON"></td>
												<td nowrap>&nbsp;</td>				
											</tr>											
											</tr>
											<tr class="field2">
											...
											<tr class="field2">
												...
												<td colspan="2">
													<select size="1" name="paymentMethod" class ="FieldShort" onchange = "activePaymentID()">
														<option value=""></option>
											...
											<tr class="field2">
												...
												<td nowrap colspan="5">
													<input class="FieldDR" type="text" name="lastName3" value = "" size="20">
												</td>
											</tr>
											<tr class="field2">
												<td nowrap>Statement Frequency</td>
												<td nowrap colspan="5">
													<input class="FieldDR" type="text" name="lastName4" value = "" size="20">
												</td>
											</tr>
										...
										<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr class="field3">
												...
												Literature</td>
												<td nowrap>
													<input type="checkbox" class="checkbox"  name="C8" value="ON" style="padding-left:0px">
												</td>
											</tr>
											<tr class="field3">
												<td nowrap>Promotional Calls</td>
												<td nowrap>
													<input type="checkbox" class="checkbox"  name="C9" value="ON" style="padding-left:0px">
												</td>
											</tr>
											<tr class="field3" height ="81">
...
<script language="javascript">
	...
	function activePaymentID() {
		if((document.getElementById("paymentMethod").value == "Payment card") || (document.getElementById("paymentMethod").value == "Bank Giro")){
			frmMorses.RefNo.disabled = false;			
		}else{
			frmMorses.RefNo.disabled = true;
			frmMorses.RefNo.value ="";	
		}
	}
</script>
</html>