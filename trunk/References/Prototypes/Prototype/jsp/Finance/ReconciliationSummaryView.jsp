...
<body class="body" onload="javascript:doShowCurrent();">
		...
		<tr>
			...
			<td valign="top" height="650">
				<table border="0" width="100%" cellpadding="0" cellspacing="0" class="Form">
						...
						<td colspan="2">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="buttontop">
								...
								<tr>
									...
									<td><img src="../images/tab_02_01.gif" width="5" height="21" border="0"></td>
									<td align="center" background="../images/tab_02_02.gif" nowrap><a href="../Staff/AdditionalDataView.jsp"class="buttontop"><b>Additional Data</b></a></td>
									<td><img src="../images/tab_02_03.gif" width="5" height="21" border="0"></td>
								...
								<tr>
									<td>
										<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr class="field220">
												<td nowrap>Select Period </td>
												<td nowrap>
													<select size="1" name="period" class="FieldWidth100" style="width:70%" onChange="javascript:doChangePeriod();" ondblclick="javascript:doChangePeriod();">
														<option value="0">Current Reconciliation</option>
														<option value="1">History</option>
													</select>
												</td>
												<td nowrap><span id="fromDate"></span></td>
												<td nowrap><span id="toDate"></span></td>
												<td nowrap><span id="button"></span></td>
											</tr>
											<tr class="field220">
					...
					<tr class="btnormal">
						<td>&nbsp;</td>
						<td colspan="2"><a class=btnormal2 href="javascript:doAmend()" target="_self">Amend</a></td>
						<td>&nbsp;</td>
					</tr>
				</table>
			</td>
...
<script language="javascript">
	function doAmend() {
		window.location.href="ReconciliationSummary.jsp"
	}
...
//		*/
	...
	function doChangePeriod() {
		var period = window.frmMorses.period;
		if (period.value == 0) {
			doShowCurrent();
	...
	function doShowCurrent() {
		...
		var fromDate = 'From Date&nbsp;01\/09\/2005 11:33:39';
		var toDate   = 'To Date&nbsp;13\/09\/2005 11:33:59';
	...
	function doShowHistory() {
		...
		var fromDate = 'From Date&nbsp;' +
						'<input class="FieldxDate" type="text" id="fromDate" name="fromDate" value="" maxlength="19">&nbsp;' +
		...
		var toDate	= 'To Date&nbsp;' +
						'<input class="FieldxDate" type="text" id="toDate" name="toDate" value="" maxlength="19">&nbsp;' +
		...
		var button	= '<a class="btnormal2" href="javascript:doSearch();" target="_self">Search<\/a>';
	...
	function doSearch() {
		var result = '<select size="1" class="FieldWidth100" style="width:70%">' +
					 '	<option value="123456">123456 - 01\/08\/05 to 05\/08\/05<\/option>' +
					 '	<option value="254367">254367 - 25\/07\/05 to 29\/07\/05<\/option>' +
					 '	<option value="897654">897654 - 18\/07\/05 to 22\/07\/05<\/option>' +
					 '	<option value="234876">234876 - 11\/07\/05 to 15\/07\/05<\/option>' +
					 '<\/select>';
