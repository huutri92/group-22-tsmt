				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0" class="Form">
					...
					<tr>
						...
						<td colspan="2">
							...
							<tr class="Field2">
								<td nowrap>
													<select size="1" name="ReasonCode" class="FieldLong">
														<option value=""></option>
														<option value="">Cash 
														Lost</option>
														<option value="">Cash 
								...
								<td nowrap>
									<input class="Field" type="text" name="" value="" size="20"></td>
								<td nowrap>
									<input class="FieldLong" type="text" name="" value="" size="20"></td>
							</tr>
							</table>
						</td>
						<td>&nbsp;</td>
...
<script language="javascript">
	...
	function doSave() {
		window.location.href="PopBankDiff.jsp";
	}
	function doCancel() {
		window.location.href="PopBankDiff.jsp";
	}
