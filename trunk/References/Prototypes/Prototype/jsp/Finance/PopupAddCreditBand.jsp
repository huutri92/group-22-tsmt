...
<head>
	...
	<title>Add Credit Control Band</title>	
</head>
			...
			<td colspan="2">
				<table class="Form" border="0" width="100%" cellpadding="1" cellspacing="1">
					...
					<tr>
						...
						<td class="Field"><input class="FieldNormal" type="text" name="bandName" value=""></td>
					</tr>
					<tr>
						<td class="Field">Debit Performance From <font color="red">*</font></td>						
						<td class="Field"><input class="FieldShort" type="text" name="dpFrom" value=""> %</td>
					</tr>
					<tr>
						<td class="Field">Max Sales Allowed <font color="red">*</font></td>						
						<td class="Field">&pound; <input class="FieldShort" type="text" name="maxSalesAllowed" value=""></td>
					</tr>
					<tr>
						<td class="Field">Max Balance Aftersale Allowed <font color="red">*</font></td>						
						<td class="Field">&pound; <input class="FieldShort" type="text" name="maxBalanceAftersale" value=""></td>
					</tr>		
				</table>
			</td>
			<td>&nbsp;</td>
