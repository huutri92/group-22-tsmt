						...
						<td colspan="2">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="buttontop">
								...
								<tr>
									...
									<td align="center" background="../images/tab_01_02.gif" class="selected" nowrap><b>Refunds</b></td>
						...
						<td colspan="2">
							<table class="FormWithBorder" border="0" width="100%" cellpadding="1" cellspacing="1">
											...
											<tr>
												...
												<th class="Title"><b>Adjustment</b></a></th>
											...
											<tr class="Field">
												...
												<td nowrap>&lt;value&gt;</td>
												<td nowrap>
													<a href="javascript:doViewTransaction()">&lt;Reason Code&gt;</a></td>
											</tr>
											<tr class="Field2">
												<td nowrap>
												&lt;Customer Id&gt;</td>
...
<script language="javascript">
	...
	function doViewTransaction() {
		document.location.href="PopLoanSales_RefundsViewDetails.jsp";
	}
	function doClose() {
		window.close();
	}	
