...
<form name="frmMorses" method="post">
	<table border="0" width="100%" cellpadding="0" cellspacing="0" class="Form">
					...
					<tr>
						...
						<td>
							<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
									...
									<td valign="top">
										<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr>
												...
												<td>&nbsp;</td>
												<td class="Field">Sale value</td>
												<td class="Field">&pound; 525.00</td>
											</tr>
											<tr>
												...
												<td class="Field"><span id="spanAgreementNumber">AN001234</td>
											</tr>
											<tr>
												<td valign="top" class="Field">&nbsp;</td>
												<td class="Field">&nbsp;</td>
												<td>&nbsp;</td>
												<td class="Field">Sale Date</td>
											...
											<tr>
												...
												<td class="Field"><input type="checkbox" class="checkbox" name="chkRefinance" disabled></td>											
											</tr>
											<tr>
												<td class="Field">Product</td>
												<td class="Field">22 weeks fixed term loan</td>
												<td>&nbsp;</td>
												<td class="Field">New Account</td>
												<td class="Field">
												<input type="checkbox" name="chkNewAccount" class="checkbox" disabled value="ON"/></td>
											</tr>
											<tr>
												<td class="Field">&nbsp;</td>
												<td class="Field">
												...
												<td class="Field"><span id="spanItem">AB0012340000000001</td>
											</tr>
								...
								<tr>
									<td>
										<table border="0" width="100%" cellpadding="1" cellspacing="1" class="FormWithBorder">
											...
											<tr class="Section">
												<th class="Title" colspan="11" align="center"><b>RECORD TRANSACTIONS - SALE</b></th>											</tr>
											<tr class="Section">
								...
								<tr>
									<td align="right">Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>200.00</b></td>
								</tr>
							</table>
						</td>
						<td>&nbsp;</td>
					...
					<tr class="btnormal">
						<td>&nbsp;</td>
						<td>
							<a href="PopLoanSales_SalesAmend.jsp" class="btnormal">Amend</a>&nbsp;&nbsp;
