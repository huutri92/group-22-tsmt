						...
						<td colspan="2">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="buttontop">
								...
								<tr>
									...
									<td align="center" background="../images/tab_01_02.gif" class="selected"><b>
									Amend Product</b></td>
								...
								<tr>
									<td valign="top">
										<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr class="Section">
												<th class="Title" colspan="2"><b>
												KEY PRODUCT DETAILS</b></th>
											</tr>
											<tr>
												<td height="5" colspan="2"></td>
											</tr>
											<tr>
												<td class="Field" height="20">Product ID<font color="red">&nbsp;*</font></td>
											...
											<tr>
												...
												Identifier<font color="red">&nbsp;*</font></td>
									...
									<td valign="top">
										<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr class="Section">
												<th class="Title" colspan="4"><b>
												PRODUCT INTEREST</b></th>
											</tr>
											<tr>
											...
											<tr>
												...
												<td class="Field">Interest Added 
												Frequency<font color="red">&nbsp;*</font></td>
												<td class="Field">
											...
											<tr>
												...
												<td class="Field"><input type="text" name="T24" size="20"> 
												%</td>
												<td class="Field">&nbsp;</td>
												<td class="Field">&nbsp;</td>
											</tr>
...
&nbsp;</td>
								...
								<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
									...
									<table class="FormWithBorder" border="0" width="100%" cellpadding="0" cellspacing="0">
											...
											<tr>
												<td class="Field">Business 
												Stream<font color="red">&nbsp;*</font></td>
												<td class="Field">&nbsp;&nbsp;
					...
					<tr class="btnormal">
						<td>&nbsp;</td>
						<td nowrap><a href="javascript:doSave();" class="btnormal">Save</a>&nbsp;
