...
<td><input class="frmInput" type="text" size="50" name="organisation"></td>
</tr>
<tr>
<td class="frmText" style="color: #000000; font-weight:normal;">
bankTransactionGUID</td>
<td class="frmText" style="color: #000000; font-weight:normal;">string</td>
<td><input class="frmInput" type="text" size="50" name="buildingNumberOrName"></td>
</tr>
<tr><td></td><td></td>
