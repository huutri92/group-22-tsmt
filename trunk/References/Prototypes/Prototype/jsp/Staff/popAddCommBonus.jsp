...
<div id="dvData" style="position:relative; height: 211px; width:100%; overflow:auto" onscroll="sync()">
					...
					<tr class=field2>
						<td>
													<select size="1" name="ReasonCode8"style="width:90%">
						...
						<td>
						<input class="FieldNormal" type="text" name="BonusValue8" value=""style="width:30%"></td>
						<td>
						<input class="FieldNormal" type="text" name="Notes8" value="" size="20"style="width:100%"></td>
					</tr>
