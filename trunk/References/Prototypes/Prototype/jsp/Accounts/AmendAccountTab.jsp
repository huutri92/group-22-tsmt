			...
			<td valign="top" height="*">
				<table border="0" width="100%" cellpadding="0" cellspacing="0" class="Form">
						...
						<td colspan="2">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="buttontop">
								...
								<tr>
									...
									<td align="center" background="../images/tab_01_02.gif" class="selected"><b>Amend Account</b></td>
									<td><img src="../images/tab_01_03.gif" width="5" height="21" border="0"></td>
									<td>&nbsp;</td>
									<td><img src="../images/tab_02_01.gif" width="5" height="21" border="0"></td>
									<td align="center" background="../images/tab_02_02.gif" class="selected"><a href="../Accounts/AccountAdjustmentTab.jsp" class="buttontop"><b>Account Adjustment</b></a></td>
					...
					<tr class="btnormal">
						<td>&nbsp;</td>
						<td colspan="2">
							<a href="../Customer/CustomerSaleTransaction.jsp" class="btnormal" tabindex="25">Save</a>&nbsp;&nbsp;
							<a href="javascript:doNewSale();" class="btnormal" tabindex="25">New Sale</a>
						</td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						...
						<td colspan="2">
							<table border="0" width="100%" cellpadding="1" cellspacing="1" class="FormWithBorder">
								...
								<tr class="Section">
									...
									<th class="Title"><b>Product Identifier</b></th>
									<th class="Title"><b>Product Type</b></th>
									<th class="Title"><b>Status</b></th>
									<th class="Title"><b>Product Partner</b></th>
									<th class="Title" nowrap><b>Interest Rate (%)</b></th>
									<th class="Title" nowrap><b>Sale Amount (&pound;)</b></th>
									<th class="Title" nowrap>Sale Date</th>
								</tr>
								<tr class="Field2">
									<td>2</td>
									<td>CAC</td>
...
<script language="javascript">
	function doNewSale() {
		var width = 400;
		var height = 200;
		var newWin = window.open("../Accounts/NewSale.jsp", "Consolidated", centerWindow(width, height));
	}
</script>
</body>
