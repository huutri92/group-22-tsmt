...
<head>
	...
	<title>Search Reason Code</title>
</head>
			...
			<td valign="top" height="*">
				<table border="0" width="100%" cellpadding="0" cellspacing="0" class="Form">
						...
						<td colspan="2">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="buttontop">
								...
								<tr>
									...
									<td align="center" background="../images/tab_01_02.gif" class="selected"><b>Search Code Reason</b></td>
					...
					<tr>
						...
						<td colspan="2">
							<table border="0" width="100%" cellpadding="0" cellspacing="0" class="FormWithBorder">
								...
								<tr>
									<td class="Field">Reason Code ID</td>
									<td>&nbsp;</td>
					...
					<tr class="btnormal">
						<td>&nbsp;</td>
						<td colspan="2">
							<a href="SearchReasonCodeResult.jsp" class="btnormal" tabindex="25">Search</a>&nbsp;
							<a href="javascript:doReset()" class="btnormal">Reset</a>&nbsp;
							<a href="SetupReasonCode.jsp" class="btnormal">Setup Reason Code</a>
						</td>
						<td>&nbsp;</td>
					</tr>					
				</table>
