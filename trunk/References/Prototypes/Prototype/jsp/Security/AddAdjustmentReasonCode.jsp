			...
			<td colspan="2">
				<table border="0" width="100%" cellpadding="0" cellspacing="0" class="FormWithBorder">
					...
					<tr class="Field">
						<td>Description</td>
						<td>&nbsp;</td>
						<td colspan="3">&nbsp; <input type="text" class="FieldLong" name="" value=""></td>
					</tr>															
					<tr class="Field">
						<td>Balance</td>
						<td>&nbsp;</td>
					...
					<tr class="Field">
						...
						<td colspan="2">&nbsp;<input type="text" class="FieldShortR" name="" value=""></td>
						<td><input type="text" class="FieldXShort" name="" value=""> %</td>
					</tr>															
					<tr class="Field">
						<td>Auth Level</td>
						<td>&nbsp;</td>
					...
					<tr class="Field">
						...
						<td>&nbsp;</td>
						<td><input type="checkbox" class="checkbox" name="d" value="1"></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>															
					<tr class="Field">
					...
					<tr class="Field">
						<td>Ledger Codes </td>
						<td>&nbsp;</td>
						<td colspan="3">&nbsp;<input type="text" class="FieldShortR" name="" value="" size="20"></td>
					</tr>															
					<tr class="Field">
						<td>Status</td>
						<td>&nbsp;</td>
